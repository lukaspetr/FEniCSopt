...
for setup in setups:
	...
	rs.make_results('RESULTS/' + str(SC_EXAMPLE) + 'indCross', NUM_CELL, V, W, uh, u_exact, yh, res_phi, results)

# Global results
rs.make_global_results('RESULTS/' + str(SC_EXAMPLE) + 'indCross', global_results)
