...
for setup in setups:
	...
	rs.make_results_sold_par('RESULTS/' + str(SC_EXAMPLE) + 'indCrossSOLD', NUM_CELL, V, W, yh2)

# Global results
rs.make_global_results('RESULTS/' + str(SC_EXAMPLE) + 'indCrossSOLD', global_results)
